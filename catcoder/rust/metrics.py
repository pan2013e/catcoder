...
class CratePassK(Metric):
    def __init__(self, n: int, k: int | list[int], fn_codes: list[list[str]], crate_base: str, data):
        self.n = n
        if isinstance(k, int):
            self.k = [k]
        else:
